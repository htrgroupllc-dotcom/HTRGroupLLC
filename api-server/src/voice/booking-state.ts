/** Fields collected during a live phone booking call. */
export interface BookingState {
  ...
  zip?: string;
  preferredDate?: string; // "Apr 15, 2026"
  preferredTime?: string; // "9:00 AM"
  /** Full slot label for DB: "Wed, Apr 15, 2026 — 9:00 AM" */
  selectedSlot?: string;
}
