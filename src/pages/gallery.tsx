...
const SOCIALS = [
  ...
  { icon: <FaInstagram  className="h-4 w-4" />, href: "https://instagram.com", label: "Instagram", bg: "linear-gradient(135deg,#f9ce34,#ee2a7b,#6228d7)" },
  { icon: <FaTiktok     className="h-4 w-4" />, href: "https://tiktok.com",    label: "TikTok",    bg: "#010101" },
  { icon: <FaLinkedinIn className="h-4 w-4" />, href: "https://linkedin.com",  label: "LinkedIn",  bg: "#0A66C2" },
